...
public class StandardData {
    ...
    @Builder
    public StandardData(String animalSpecies, String animalBreed, Neutral neutralYn, ProcessState processState, int animalAge, int happenDt, int animalCount, int happenArea) {
